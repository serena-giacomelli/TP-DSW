...
const usuarios = [
    new Usuario('Serena', 'Giacomelli', '45638062', 'sere@gmail.com', new Date('2004-05-23')),
    new Usuario('Chiara', 'Leonnardi', '2058365', 'chiara@gmail.com', new Date('2000-07-04')),
];
...
app.post('/api/usuarios', sanitizeUsuarioInput, (req, res) => {
    ...
    const newUsuario = new Usuario(input.nombre, input.apellido, input.dni, input.email, input.fechaNacimiento);
...
//# sourceMappingURL=crudUsuarios.js.map